...
public class PRSummaryBean {
	...
	public List<PRDetailBean> prDetailList = new ArrayList<PRDetailBean>();
	...
	public List<PRDetailBean> getPrDetailList() {
		return prDetailList;
	}
	public void setPrDetailList(List<PRDetailBean> prDetailList) {
